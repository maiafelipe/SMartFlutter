...
/// Classe DBProvider.
///
/// Deverá configuar e manter ligação com
/// recurso de BD em SQLite.
///
/// Singleton: pemite a criação de uma única
/// intancia dessa classe.
///
/// Pode deve ser chamada por qualquer DAO que
/// manipule o banco de dados.
///
/// @author Felipe
class DBProvider {
  /// Instância única dessa classe.
  /// Qualquer solicitação de uma nova instância deve
  /// retornar esse objeto static.
  ...
  /// Metodo getInstance.
  /// Método que pode ser chamado (sem instanciação)
  /// para solicitar uma instância dessa classe.
  /// Caso a instância já exista ela é retornada.
  /// Caso a instância ainda não existe, ela é
  /// criada antes.
  /// Garante o comportamento Singleton.
  ...
  /// Não pode ser null, mas pode ser inicializada
  /// posteriormente (late).
  ...
  /// a inicialização ocorrer.
  /// Pode demovar, por isso é async.
  /// É necessário esperar pela inicialização para
  /// continuar, por isso o wait.
  ...
  /// É configurado o caminho, o nome e os
  /// comportamentos para criação e atualização.
